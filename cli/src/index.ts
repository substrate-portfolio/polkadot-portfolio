...
import { priceOf, scrape, Asset, Summary, ApiPromise, makeApi } from 'polkadot-portfolio-core';
...
export async function main() {
	...
	await Promise.all(
		accountConfig.networks.map(async (uri: string) => {
			...
			console.log(
				`✅ Connected to ${uri} / decimals: ${api.registry.chainDecimals.toString()} / tokens ${
